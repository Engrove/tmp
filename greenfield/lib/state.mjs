...
const ALLOWED = Object.freeze({
  // v1.8.1: SENDING -> QUEUE_WAIT is the schedule dispatch gate (never after a dispatch attempt).
  [PHASES.SENDING]: new Set([PHASES.WAITING, PHASES.RECOVERING, PHASES.ROTATING, PHASES.BLOCKED, PHASES.STOPPED, PHASES.AUDIT_FAILURE, PHASES.DETACHED, PHASES.QUEUE_WAIT]),
  // v1.8.3: WAITING -> QUEUE_WAIT when a provider content block pauses the only runnable slot.
  [PHASES.WAITING]: new Set([PHASES.SENDING, PHASES.ANALYZING, PHASES.RECOVERING, PHASES.ROTATING, PHASES.BLOCKED, PHASES.STOPPED, PHASES.AUDIT_FAILURE, PHASES.DETACHED, PHASES.QUEUE_WAIT]),
  [PHASES.ANALYZING]: new Set([PHASES.SENDING, PHASES.PAUSED, PHASES.RECOVERING, PHASES.ROTATING, PHASES.BLOCKED, PHASES.DONE, PHASES.STOPPED, PHASES.AUDIT_FAILURE, PHASES.DETACHED, PHASES.QUEUE_WAIT]),
  ...
  [PHASES.QUEUE_WAIT]: new Set([PHASES.STOPPED])
});
