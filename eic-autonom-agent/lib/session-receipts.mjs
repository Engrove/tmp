import { conversationKeyFromUrl, sanitizeText } from "./common.mjs";
...
export function sessionIdentityFromPage(page = {}, tabId) {
  ...
  return {
    kind: "blank-tab",
    value: `${sanitizeText(page.url || "https://chatgpt.com/", 2000)}#tab:${Number(tabId)}#epoch:${sanitizeText(page.documentEpoch || "unknown", 180)}`
  };
}
