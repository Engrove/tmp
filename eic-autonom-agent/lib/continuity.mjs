import {
  ...
  nowIso, randomId, sanitizeText, sha256Hex, stableStringify, utf8Bytes
} from "./common.mjs";
  ...
  return {
    ...
    scope: {
      ...
      windowId: scopeWindowId !== null && scopeWindowId !== undefined && scopeWindowId !== "" &&
        Number.isInteger(Number(scopeWindowId)) && Number(scopeWindowId) >= 0
...
export function normalizeContinuity(value) {
  ...
  const result = {
    ...
    mainTaskBaseline: normalizeMainTaskBaseline(value.mainTaskBaseline),
    trackControl: normalizeTrackControl(value.trackControl, {
      baselinePresent: Boolean(normalizeMainTaskBaseline(value.mainTaskBaseline)),
