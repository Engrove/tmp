...
export const SESSION_DB_NAME = "eic-autonom-agent-v0.12.0";
...
export const SESSION_DB_POINTER_KEYS = Object.freeze({
  ACTIVE_CAPTURE_ID: "eicAutonomAgent.v1200.activeCaptureId",
  ACTIVE_MEMORY_ID: "eicAutonomAgent.v1200.activeSessionMemoryId",
  READINESS: "eicAutonomAgent.v1200.sessionContextReadiness"
});
